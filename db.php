...
class EloquentWP_DB_Adapter extends \wpdb {
	...
	public function get_results( $query = null, $output = OBJECT ) {
		return parent::get_results( $query, $output ); // TODO: Change the autogenerated stub
	}

	public function get_caller()
	{
		return parent::get_caller(); // TODO: Change the autogenerated stub
	}

	public function get_col($query = null, $x = 0)
	{
		return parent::get_col($query, $x); // TODO: Change the autogenerated stub
	}

	public function get_blog_prefix($blog_id = null)
	{
		return parent::get_blog_prefix($blog_id); // TODO: Change the autogenerated stub
	}
}
